...
class MainPage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.mainButton.setOnClickListener{
            val intent = Intent(this@MainPage, WhichModel::class.java)
            startActivity(intent)
            finish()
        }
        binding.footerLayout.section1Line.visibility=View.VISIBLE
        ...
        binding.kisayolEkleClick1.setOnClickListener{
            binding.kisayolEkleClick1.setOnClickListener{
                val intent  = Intent(this@MainPage, WhichModel::class.java)
                startActivity(intent)
                finish()
        ...
        binding.kisayolEkleClick2.setOnClickListener{
            Toast.makeText(this,"U already in main page",Toast.LENGTH_LONG).show()
        }
    }
